...
### 1. FIFO ( First-In, First-Out ) Protocol :

          How it works: Removes oldest cache entry
          Use: Simple systems, low hardware cost
...
### 2. LIFO ( Last-In, First-Out ) Protocol :
          ...
          How it works: Removes most recent entry
          Use: Stack-based access patterns
...
### 4. LRU ( Least Recently Used ) Protocol :
          ...
          How it works: Removes least recently accessed
          Use: Most CPUs, highest hit rate 
...
### 5. PLRU ( Pseudo-LRU ) Protocol :
          ...
          How it works: Approximates LRU with less overhead
